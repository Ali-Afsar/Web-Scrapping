# Web Data Scraping using R for IMDB Movies rating 2017
...
# Check length of metascore data(We are scraping 100 movies records but it is of 99)

length(metascore_data)

# Now I found that Movie No 61 does not have metascore (look visually)

# Now Fill the NA at 61 No Movies

metascore_data <- append(metascore_data, "NA", after = 60)
...
# Movies does not have gross earning are c(18,45:47,61,65,67,80,82,85,87,91,93,98:100)

# Now Imputing NA at the following places as I found it does not have Gross Earning

for (i in c(18,45:47,61,65,67,80,82,85,87,91,93,98:100)) {
