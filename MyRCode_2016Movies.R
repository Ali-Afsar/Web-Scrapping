# Web Data Scraping using R for IMDB Movies rating 2016
...
# Now Fill the NA at 25,81 No. Movies

metascore_data <- append(metascore_data, "NA", after = 24)

metascore_data <- append(metascore_data, "NA", after = 80)
...
# I found that only 93 Movies has gross earning out of 100. 

# Movies does not have gross earning are c(25,63,80,85,87,97,99)

# Now Imputing NA at the following places as I found it does not have Gross Earning

for (i in c(25,63,80,85,87,97,99)) {
